...
INSTRUCTIONS = ('This server drives the user\'s REAL desktop. Control is theirs to give: call control with '
                ...
                'screenshot for input. not_owner or stale_generation means the human revoked or changed '
                'control: stop, observe again, and never retry blindly. wrong_target means you still '
                'have control but aimed at something that cannot be typed into -- another window has '
                'focus, or a surface is in the way: observe and aim again. An input error carrying '
                'delivered/of counts means part of the batch already landed, so observe before retrying '
                'or you will type the delivered prefix twice. '
